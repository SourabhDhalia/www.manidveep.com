(() => {
    ...
    t = (function () {
      ...
      try {
        ...
        e =
          (t && t.debug) ||
          (t.location &&
            (t.location.search || '').toLowerCase().indexOf('debug=') > -1);
      } catch (e) {}
      return e;
    })();
  function n(n) {
  ...
  function l(e, t, n) {
    ...
    u
      ? ((o = document.createEvent('CustomEvent')),
        o.initCustomEvent(e, !0, !0, n))
      : (o = new CustomEvent(e, { detail: n })),
      t &&
        t.dispatchEvent &&
        setTimeout(() => {
          t.dispatchEvent(o);
    ...
    if (
      (e instanceof HTMLScriptElement &&
        E.forEach((o) => {
          !t &&
            o.tag.appInfo &&
            o.embeddedNodes.forEach((r) => {
              var i;
              t ||
                (r === e &&
                  ((n =
                    (null == (i = o.tag) || null == (i = i.appInfo)
                      ? void 0
                      : i.id) || ''),
                  (t = !0)));
            });
  ...
  function U(e, t, n, o) {
    return () => {
      o(n),
        ...
        l(e, window, { tagName: t, embed: r(n) });
    };
  }
  ...
  function F(e, t) {
    const n = (function () {
        let e = '';
        for (let t = 0; t < 16; t++)
          e += B.charAt(Math.floor(52 * Math.random()));
        return e;
      })(),
      o = (function (e) {
    ...
    return {
      moduleScriptConfig: {
        node: { tag: 'SCRIPT', attributes: { type: 'module' }, content: r },
        callbacks: {
          onload: function () {
      ...
      helperScriptConfig: { tag: 'SCRIPT', content: o },
    };
  }
  function _(e, t, n) {
    let o;
    return (
      e.nodeType === Node.TEXT_NODE
        ? (o = document.createTextNode(e.content))
        : e.nodeType === Node.COMMENT_NODE
        ? (o = document.createComment(e.content))
        : ((o = document.createElement(e.tag)),
          e && e.attributes instanceof NamedNodeMap
            ? Array.prototype.forEach.call(e.attributes, (e) => {
                q(o, e.name, e.value);
              })
          ...
          'SCRIPT' === e.tag
            ? (o = (function (e, t, n, o) {
                ...
                if (
                  o &&
                  'module' === e.getAttribute('type') &&
                  'true' === e.getAttribute('accesstoken')
                ) {
                  let r = e.src;
                  !r && t && (r = J(t)), (e = null);
                  const { helperScriptConfig: i, moduleScriptConfig: c } = F(
                      r,
                      o
                    ),
                    a = () => {
                  ...
                  return _(
                    i,
                    { onload: a, onerror: null == n ? void 0 : n.onerror },
                    o
                  );
                }
                !(function (e, t, n) {
  ...
  function J(e) {
    const t = new Blob([e], { type: 'text/javascript;charset=utf-8' });
  ...
  function Y(e) {
    ...
    return (
      (n.innerHTML = e),
      Array.prototype.forEach.call(n.childNodes, (e) => {
        const n = z(e);
        t.push(n);
      }),
      t
  ...
  function W(e, t, n) {
    const o = e.filter((e) => !e.embeddedNodes),
      r = i(n, 'specs.tagManagerRenderTagByPageID')
        ? (function (e, t) {
            return e.filter((e) =>
              (function (e, t) {
                return (
                  !(
                    t.id &&
                    ((n = e),
                    null != (o = n.tag) && null != (o = o.pages) && o.length)
                  ) ||
                  ((e, t) => {
                    var n;
                    return (
                      (null == (n = e.tag) || null == (n = n.pages)
                        ? void 0
                        : n.includes(t.id || '')) || !1
                    );
                  })(e, t)
    ...
    P(c),
      ...
      r.forEach((e) => {
        ...
        const o = e.tag,
          r = Y(o.content),
          i =
            o.position && o.position.toLowerCase() !== V.HEAD
              ? document.body
              : document.head;
        !(function (e, t, n, o, r, i) {
          ...
          const a = () => {
            ...
            s = () => {
              (c -= 1), c >= 0 && H(t.onerror, { error: !0 });
            },
            d = n.firstChild;
          e.forEach((e) => {
            'SCRIPT' === e.tag && (c += 1);
            const t = _(e, { onload: a, onerror: s }, i);
            r.push(t), o ? n.insertBefore(t, d) : n.appendChild(t);
          }),
            0 === c && H(t.onload, {}, !0);
        })(
          r,
          { onload: U(p, o.name, o, O), onerror: U(m, o.name, o, M) },
          i,
          o.position === V.BODY_START,
          e.embeddedNodes,
          n
        );
      });
    ...
    c.open(a, s, !0),
      (c.onreadystatechange = () => {
        if (4 === c.readyState) {
          const e = c.status;
          e < 200 || e >= 300
            ? H(n, { status: e, responseText: c.responseText })
            : H(t, c.responseText);
        }
      }),
  ...
  function K(e, t) {
    const c = o(e),
      { currentPageID: a, initConsentPolicyManager: s = !1 } = t;
    if (
      (c.errors && c.errors.length > 0 && n(JSON.stringify(c.errors)), c.config)
    ) {
      const e = window.consentPolicyManager;
      (u = c.config.consentPolicy) &&
        'object' == typeof u &&
        (v = [...v, ...N(u)]),
        s && e && e.init({ consentPolicy: c.config.consentPolicy }),
        'object' != typeof (d = c.config) ||
          Array.isArray(d) ||
          ((I = { ...I, ...d }), l(h, window, r(I)));
    }
    var d, u, f, g;
    if (c.tags) {
      (f = c.tags),
        i(
          null == (g = I) ? void 0 : g.experiments,
          ...
          ? f.forEach((e) => {
              ...
              const n =
                ...
                (null == (t = e.content)
                  ? void 0
                  : t.includes('load-once="true"'));
              E.push({ tag: { ...e, loadOnce: n }, embeddedNodes: null });
            })
          : f.forEach((e) => {
              E.push({ tag: e, embeddedNodes: null });
            });
      const e = { id: a };
  ...
  async function Z(e) {
    const {
      ...
      u = G('apps-override'),
      l = Q(r, t, i),
      f = window.consentPolicyManager,
      g = !i && f ? f._getConsentPolicyHeader() : {},
      p = (function (e) {
    ...
    h && (g.authorization = h),
      X(
        l,
        (e) => {
          K(e, { initConsentPolicyManager: !a && !!i, currentPageID: p.id });
        },
        (e) => {
  ...
  !(function () {
    ...
    function t() {
      ...
      !(function () {
        ...
        t.registerToEvent('pageNavigation', ee),
        document.addEventListener('consentPolicyChanged', te);
    }
    !(function () {
      const n = e.wixEmbedsAPI;
      n && 'function' == typeof n.registerToEvent
        ? t()
        : e.addEventListener('wixEmbedsAPIReady', t, !1);
    })();
  })();
})();
