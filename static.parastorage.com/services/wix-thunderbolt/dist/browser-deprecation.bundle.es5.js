...
(function () {
  ...
  function sendBI(evid) {
    ...
    var is_rollout =
      fleetConfig.code === 0 || fleetConfig.code === 1
        ? fleetConfig.code
        : null;
    var pageVisibilty = document.visibilityState;
    var types = { WixSite: 1, UGC: 2, Template: 3 };
  ...
  function reportPhaseStarted(phase, extra) {
    ...
    sendBI(
      evid,
      '&name='
        .concat(phase, '&duration=')
        .concat(duration)
        .concat(extra ? '&' + extra : '')
    );
  } // src/browser-deprecation.ts
  var version = 'v5';
  var _window2 = window;
  var _a, _b, _c;
  var userAgent =
    ((_c =
      (_b = (_a = _window2.navigator) == null ? void 0 : _a.userAgent) == null
        ? void 0
        : _b.toLowerCase) == null
      ? void 0
      : _c.call(_b)) || '';
  var _a2;
  var isIEbyDocumentMode = !!((_a2 = _window2.document) == null
    ? void 0
    : _a2.documentMode);
  var isIEByUA = !!(
    userAgent.match(/msie\s([\d.]+)/) ||
    userAgent.match(/trident\/[\d](?=[^\?]+).*rv:([0-9.].)/)
  );
  var isIE = isIEbyDocumentMode || isIEByUA;
  var requiredBrowserNativeApis = [
    'customElements',
  ...
  var isSafari14InStudio = function isSafari14InStudio() {
    ...
    var isWixStudio =
      ((_b2 = (_a3 = _window2.viewerModel) == null ? void 0 : _a3.site) == null
        ? void 0
        : _b2.editorName) === 'Studio';
  ...
  function getIframeUrlForOldBrowserMessage() {
    var _a3;
    var userLanguage =
      ((_a3 = _window2.viewerModel) == null
        ? void 0
        : _a3.language.userLanguage) || 'en';
    var supportedLanguages = { pt: 1, fr: 1, es: 1, de: 1, ja: 1 };
    var messageLanguage = supportedLanguages[userLanguage]
      ? userLanguage
      : 'en';
    return './static.parastorage.com/services/wix-thunderbolt/dist/deprecation-'
      .concat(messageLanguage, '.')
      .concat(version, '.html');
  }
  function reportBI() {
    ...
    reportPhaseStarted(
      ...
      'supportedFeatures='.concat(JSON.stringify(supportedFeatures))
    );
  }
  function muteSentry() {
    _window2.Sentry = { mute: true };
  }
  function supportsCssVars() {
    ...
    var isSupported = !!(
      _window2.CSS &&
      _window2.CSS.supports &&
      _window2.CSS.supports('font-weight', 'var(--tmp-var)')
    );
    (_b2 =
      (_a3 = styleElement.parentNode) == null ? void 0 : _a3.removeChild) ==
    null
      ? void 0
      : _b2.call(_a3, styleElement);
    return isSupported;
  }
