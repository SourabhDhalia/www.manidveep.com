(() => {
  ...
  function naturalExponential(x, sd) {
    ...
    for (;;) {
      ...
      if (
        ...
        digitsToString(sum2.d).slice(0, wpr)
      ) {
        j = k;
  ...
  function random(sd) {
    ...
    if (!this.crypto) {
      ...
      for (; i < k; ) {
        n =
          d[i] + (d[i + 1] << 8) + (d[i + 2] << 16) + ((d[i + 3] & 127) << 24);
        if (n >= 214e7) {
  ...
  function getMultiInternalSlots(map, pl) {
    ...
    if (!slots) {
      throw new TypeError(
        ''.concat(pl, ' InternalSlot has not been initialized')
      );
    }
  ...
  var createMemoizedNumberFormat = memoize(
    function () {
      var _a;
      var args = [];
  ...
  var createMemoizedPluralRules = memoize(
    function () {
      var _a;
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
  ...
  var createMemoizedLocale = memoize(
    function () {
      var _a;
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      return new ((_a = Intl.Locale).bind.apply(
        _a,
        __spreadArray([void 0], args, false)
      ))();
    },
  ...
  var createMemoizedListFormat = memoize(
    function () {
      var _a;
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      return new ((_a = Intl.ListFormat).bind.apply(
        _a,
        __spreadArray([void 0], args, false)
      ))();
    },
    ...
    if (value !== void 0) {
      ...
      if (
        ...
        throw new RangeError(
          ''.concat(value, ' is not within ').concat(values.join(', '))
        );
      }
      return value;
    }
  ...
  var S_DOLLAR_UNICODE_REGEX = new RegExp(
    ''.concat(S_UNICODE_REGEX.source, '$')
  );
  ...
  function processData() {
    ...
    if (!PROCESSED_DATA) {
      var paradigmLocales =
        (_b =
          (_a = data.supplemental.languageMatching['written-new'][0]) ===
            null || _a === void 0
            ? void 0
            : _a.paradigmLocales) === null || _b === void 0
          ? void 0
          : _b._locales.split(' ');
      var matchVariables = data.supplemental.languageMatching[
        'written-new'
      ].slice(1, 5);
      ...
      PROCESSED_DATA = {
        ...
        paradigmLocales: __spreadArray(
          __spreadArray([], paradigmLocales, true),
          paradigmLocales.map(function (l) {
  ...
  function isMatched(locale, languageMatchInfoLocale, matchVariables) {
    ...
    matches &&
      (matches = locale.script
        ? script === '*' || script === locale.script
        : true);
    matches &&
  ...
  function findMatchingDistanceForLSR(desired, supported, data2) {
    for (var _i = 0, _a = data2.matches; _i < _a.length; _i++) {
      var d = _a[_i];
      var matches =
        isMatched(desired, d.desired, data2.matchVariables) &&
        isMatched(supported, d.supported, data2.matchVariables);
      if (!d.oneway && !matches) {
        matches =
          isMatched(desired, d.supported, data2.matchVariables) &&
          isMatched(supported, d.desired, data2.matchVariables);
      }
      if (matches) {
        var distance = d.distance * 10;
        if (
          data2.paradigmLocales.indexOf(serializeLSR(desired)) > -1 !=
          data2.paradigmLocales.indexOf(serializeLSR(supported)) > -1
        ) {
          return distance - 1;
        }
        return distance;
  ...
  function LookupMatcher(availableLocales, requestedLocales, getDefaultLocale) {
    var result = { locale: '' };
    for (
      var _i = 0, requestedLocales_1 = requestedLocales;
      _i < requestedLocales_1.length;
      _i++
    ) {
      ...
      if (keyword === void 0 && len != 2) {
        ...
        if (
          keywords.find(function (k2) {
            return (
              k2.key ===
              (keyword === null || keyword === void 0 ? void 0 : keyword.key)
            );
          }) === void 0
        ) {
        ...
        (keyword === null || keyword === void 0 ? void 0 : keyword.value) === ''
      ) {
  ...
  function ResolveLocale(
    ...
    var _loop_1 = function (key2) {
      var keyLocaleData =
        (_a =
          foundLocaleData === null || foundLocaleData === void 0
            ? void 0
            : foundLocaleData[key2]) !== null && _a !== void 0
          ? _a
          : [];
      invariant2(
        Array.isArray(keyLocaleData),
        'keyLocaleData for '.concat(key2, ' must be an array')
      );
      var value = keyLocaleData[0];
      invariant2(
        value === void 0 || typeof value === 'string',
    ...
    for (
      var _i = 0, relevantExtensionKeys_1 = relevantExtensionKeys;
      _i < relevantExtensionKeys_1.length;
      _i++
    ) {
  ...
  var isSurrogate = (str, pos) => {
    return (
      55296 <= str.charCodeAt(pos - 1) &&
      str.charCodeAt(pos - 1) <= 56319 &&
      56320 <= str.charCodeAt(pos) &&
      str.charCodeAt(pos) <= 57343
    );
  };
  ...
  var generateRuleRegex = (rule, variables, after) => {
    return new RegExp(
      `${after ? '^' : ''}${replaceVariables(variables, rule)}${
        after ? '' : '$'
      }`
    );
  };
    ...
    constructor(locales, options) {
      ...
      if (r.locale.length) {
        ...
        if (granularity in localeOverrides) {
          ...
          this.mergedSegmentationTypeValue.variables = __spreadValues(
            __spreadValues({}, this.mergedSegmentationTypeValue.variables),
            localeSegmentationTypeValue.variables
          );
          this.mergedSegmentationTypeValue.segmentRules = __spreadValues(
            __spreadValues({}, this.mergedSegmentationTypeValue.segmentRules),
  ...
  __publicField(
    _Segmenter,
    'availableLocales',
    new Set(Object.keys(SegmentationRules).filter((key) => key !== 'root'))
  );
  __publicField(_Segmenter, 'polyfilled', true);
  var Segmenter = _Segmenter;
  var createSegmentDataObject = (
    segmenter,
    segment,
    index,
    input,
